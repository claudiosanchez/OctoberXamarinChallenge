...
![Appcenter start screen](http://ttirrell.com/wp-content/uploads/2019/10/2019-10-10.png)
...
Step 2 of the ‘Getting started’ instructions for your app in App Center tells us to copy the following ‘using’ statements into our 
...
Then we need to copy and paste the following into the 

OnStart() method within the same file.
...
You will need to navigate to the instructions for each of the apps you’ve created in App Center to find the ‘App secret’ for each one. Make sure to replace 

{Your App Secret} text with the actual value for your application.
